...
function Manual () {	
	var hooks = [], decor = [], box = [], life = [], mana = [], activeAction, end, block, wp, resolution = me.screensize, resfix, lifehook, watch;
